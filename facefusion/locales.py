...
{'en': {'conda_not_activated': 'conda is not activated',
        ...
        'uis_help': {'processors': 'Enable one or more processors. Order matters for the pipeline.',
                     'processors_age_modifier': 'Modify the apparent age of detected faces.',
                     'processors_background_remover': 'Remove or replace the background of the frame.',
                     'processors_deep_swapper': 'Swap faces using a deep model with morph blending.',
                     'processors_expression_restorer': 'Restore facial expressions from the target face.',
                     'processors_face_debugger': 'Visualize face detection and landmarks for debugging.',
                     'processors_face_editor': 'Adjust facial features such as eyes, mouth, and head pose.',
                     ...
                     'processors_frame_colorizer': 'Colorize black and white or faded footage.',
                     'processors_frame_enhancer': 'Enhance overall frame quality and sharpness.',
                     'processors_lip_syncer': 'Sync lip movements to match the audio track.'}},
 'zh': {'conda_not_activated': 'conda 环境未激活',
        ...
        'choices': {'processors': {'age_modifier': '年龄修改',
                                     ...
                                     'frame_enhancer': '画面增强',
                                     'lip_syncer': '口型同步'}},
        'uis_help': {'processors': '勾选一个或多个处理器，执行顺序会影响结果。',
                     'processors_age_modifier': '修改检测人脸的显见年龄。',
                     'processors_background_remover': '移除或替换画面背景。',
                     'processors_deep_swapper': '使用深度模型换脸，支持形态融合。',
                     'processors_expression_restorer': '从目标脸恢复面部表情。',
                     'processors_face_debugger': '可视化人脸检测与关键点，用于调试。',
                     'processors_face_editor': '调整眼睛、嘴部、头部姿态等面部特征。',
                     'processors_face_enhancer': '换脸后增强面部清晰度；混合过高可能发假。',
                     'processors_face_swapper': '将源脸替换到目标画面中的人脸。',
                     'processors_frame_colorizer': '为黑白或褪色画面上色。',
                     'processors_frame_enhancer': '提升整体画面清晰度与质量。',
                     'processors_lip_syncer': '使口型与音频轨道同步。'}}}
