...
def listen() -> None:
	...
	help_helper.listen_help_button(EXPRESSION_RESTORER_MODEL_HELP_BUTTON, 'uis_help.model', MODULE_NAME)
	help_helper.listen_help_button(EXPRESSION_RESTORER_FACTOR_HELP_BUTTON, 'uis_help.factor', MODULE_NAME)
	help_helper.listen_help_button(EXPRESSION_RESTORER_AREAS_HELP_BUTTON, 'uis_help.areas', MODULE_NAME)
